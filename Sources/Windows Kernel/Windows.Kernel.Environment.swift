...
// L2-canonical form lives in swift-windows-standard's Kernel Environment
// module (carried by the Windows 32 Kernel umbrella this target already
// re-exports); swift-kernel resolves cross-platform `Kernel.Environment`
// through this alias (the POSIX legs resolve theirs via ISO_9945).
